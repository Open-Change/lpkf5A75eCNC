...
#define CSR_MMIO_INST_RESET_ADDR (CSR_BASE + 0x40L)
#define CSR_MMIO_INST_RESET_SIZE 1
#define CSR_MMIO_INST_STEPGEN_0_STEPDATA_ADDR (CSR_BASE + 0x44L)
#define CSR_MMIO_INST_STEPGEN_0_STEPDATA_SIZE 1
#define CSR_MMIO_INST_STEPGEN_1_STEPDATA_ADDR (CSR_BASE + 0x48L)
#define CSR_MMIO_INST_STEPGEN_1_STEPDATA_SIZE 1
#define CSR_MMIO_INST_STEPGEN_2_STEPDATA_ADDR (CSR_BASE + 0x4cL)
#define CSR_MMIO_INST_STEPGEN_2_STEPDATA_SIZE 1
#define CSR_MMIO_INST_STEPGEN_3_STEPDATA_ADDR (CSR_BASE + 0x50L)
#define CSR_MMIO_INST_STEPGEN_3_STEPDATA_SIZE 1
#define CSR_MMIO_INST_STEPGEN_4_STEPDATA_ADDR (CSR_BASE + 0x54L)
#define CSR_MMIO_INST_STEPGEN_4_STEPDATA_SIZE 1
#define CSR_MMIO_INST_WATCHDOG_DATA_ADDR (CSR_BASE + 0x58L)
#define CSR_MMIO_INST_WATCHDOG_DATA_SIZE 1
#define CSR_MMIO_INST_GPIO_OUT_ADDR (CSR_BASE + 0x5cL)
#define CSR_MMIO_INST_GPIO_OUT_SIZE 2
#define CSR_MMIO_INST_STEPGEN_APPLY_TIME_ADDR (CSR_BASE + 0x64L)
#define CSR_MMIO_INST_STEPGEN_APPLY_TIME_SIZE 2
#define CSR_MMIO_INST_STEPGEN_0_SPEED_TARGET_INDEX_ENABLE_ADDR (CSR_BASE + 0x6cL)
#define CSR_MMIO_INST_STEPGEN_0_SPEED_TARGET_INDEX_ENABLE_SIZE 1
#define CSR_MMIO_INST_STEPGEN_0_MAX_ACCELERATION_ADDR (CSR_BASE + 0x70L)
#define CSR_MMIO_INST_STEPGEN_0_MAX_ACCELERATION_SIZE 1
#define CSR_MMIO_INST_STEPGEN_1_SPEED_TARGET_INDEX_ENABLE_ADDR (CSR_BASE + 0x74L)
#define CSR_MMIO_INST_STEPGEN_1_SPEED_TARGET_INDEX_ENABLE_SIZE 1
#define CSR_MMIO_INST_STEPGEN_1_MAX_ACCELERATION_ADDR (CSR_BASE + 0x78L)
#define CSR_MMIO_INST_STEPGEN_1_MAX_ACCELERATION_SIZE 1
#define CSR_MMIO_INST_STEPGEN_2_SPEED_TARGET_INDEX_ENABLE_ADDR (CSR_BASE + 0x7cL)
#define CSR_MMIO_INST_STEPGEN_2_SPEED_TARGET_INDEX_ENABLE_SIZE 1
#define CSR_MMIO_INST_STEPGEN_2_MAX_ACCELERATION_ADDR (CSR_BASE + 0x80L)
#define CSR_MMIO_INST_STEPGEN_2_MAX_ACCELERATION_SIZE 1
#define CSR_MMIO_INST_STEPGEN_3_SPEED_TARGET_INDEX_ENABLE_ADDR (CSR_BASE + 0x84L)
#define CSR_MMIO_INST_STEPGEN_3_SPEED_TARGET_INDEX_ENABLE_SIZE 1
#define CSR_MMIO_INST_STEPGEN_3_MAX_ACCELERATION_ADDR (CSR_BASE + 0x88L)
#define CSR_MMIO_INST_STEPGEN_3_MAX_ACCELERATION_SIZE 1
#define CSR_MMIO_INST_STEPGEN_4_SPEED_TARGET_INDEX_ENABLE_ADDR (CSR_BASE + 0x8cL)
#define CSR_MMIO_INST_STEPGEN_4_SPEED_TARGET_INDEX_ENABLE_SIZE 1
#define CSR_MMIO_INST_STEPGEN_4_MAX_ACCELERATION_ADDR (CSR_BASE + 0x90L)
#define CSR_MMIO_INST_STEPGEN_4_MAX_ACCELERATION_SIZE 1
#define CSR_MMIO_INST_WATCHDOG_STATUS_ADDR (CSR_BASE + 0x94L)
#define CSR_MMIO_INST_WATCHDOG_STATUS_SIZE 1
#define CSR_MMIO_INST_WALL_CLOCK_ADDR (CSR_BASE + 0x98L)
#define CSR_MMIO_INST_WALL_CLOCK_SIZE 2
#define CSR_MMIO_INST_GPIO_IN_ADDR (CSR_BASE + 0xa0L)
#define CSR_MMIO_INST_GPIO_IN_SIZE 1
#define CSR_MMIO_INST_STEPGEN_0_POSITION_ADDR (CSR_BASE + 0xa4L)
#define CSR_MMIO_INST_STEPGEN_0_POSITION_SIZE 2
#define CSR_MMIO_INST_STEPGEN_0_SPEED_ADDR (CSR_BASE + 0xacL)
#define CSR_MMIO_INST_STEPGEN_0_SPEED_SIZE 1
#define CSR_MMIO_INST_STEPGEN_1_POSITION_ADDR (CSR_BASE + 0xb0L)
#define CSR_MMIO_INST_STEPGEN_1_POSITION_SIZE 2
#define CSR_MMIO_INST_STEPGEN_1_SPEED_ADDR (CSR_BASE + 0xb8L)
#define CSR_MMIO_INST_STEPGEN_1_SPEED_SIZE 1
#define CSR_MMIO_INST_STEPGEN_2_POSITION_ADDR (CSR_BASE + 0xbcL)
#define CSR_MMIO_INST_STEPGEN_2_POSITION_SIZE 2
#define CSR_MMIO_INST_STEPGEN_2_SPEED_ADDR (CSR_BASE + 0xc4L)
#define CSR_MMIO_INST_STEPGEN_2_SPEED_SIZE 1
#define CSR_MMIO_INST_STEPGEN_3_POSITION_ADDR (CSR_BASE + 0xc8L)
#define CSR_MMIO_INST_STEPGEN_3_POSITION_SIZE 2
#define CSR_MMIO_INST_STEPGEN_3_SPEED_ADDR (CSR_BASE + 0xd0L)
#define CSR_MMIO_INST_STEPGEN_3_SPEED_SIZE 1
#define CSR_MMIO_INST_STEPGEN_4_POSITION_ADDR (CSR_BASE + 0xd4L)
#define CSR_MMIO_INST_STEPGEN_4_POSITION_SIZE 2
#define CSR_MMIO_INST_STEPGEN_4_SPEED_ADDR (CSR_BASE + 0xdcL)
...
static inline uint64_t MMIO_inst_gpio_out_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x5cL));
	r <<= 32;
...
static inline uint64_t MMIO_inst_wall_clock_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x98L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x9cL));
	return r;
}
...
static inline uint64_t MMIO_inst_stepgen_0_position_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0xa4L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0xa8L));
	return r;
}
...
static inline uint64_t MMIO_inst_stepgen_1_position_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0xb0L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0xb4L));
	return r;
}
...
static inline uint64_t MMIO_inst_stepgen_2_position_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0xbcL));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0xc0L));
	return r;
}
...
static inline uint64_t MMIO_inst_stepgen_3_position_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0xc8L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0xccL));
	return r;
}
...
static inline uint64_t MMIO_inst_stepgen_4_position_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0xd4L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0xd8L));
	return r;
}
